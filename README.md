# The Forbidden Papyrus — Game Build

The standalone Windows build of **The Forbidden Papyrus**, a 3D dungeon crawler game built with **Unity Engine (6000.0.43f1)**.

> *Download and play — no Unity installation required.*
...
```
4thTime.exe                              # Main executable
UnityPlayer.dll                          # Unity runtime library
UnityCrashHandler64.exe                  # Crash handler
4thTime_Data/                            # Game assets & resources
D3D12/                                   # DirectX 12 shader cache
MonoBleedingEdge/                        # Mono runtime
4thTime_BurstDebugInformation_DoNotShip/ # Debug symbols (can be removed)
```
